...
public class ControladorUsuarios {
    ...
    @PostMapping
    public void addUsuario(@RequestBody Empleado empleado) { empleadoServicio.addEmpleado(empleado); }
    ...
    @PatchMapping("{id}")
    public void updateUsuario(@RequestBody Empleado empleado) { empleadoServicio.updateEmpleado(empleado); }

    @DeleteMapping("{id}")
    public void deleteUsuario(@PathVariable("id") Long id) { empleadoServicio.deleteEmpleado(id); }
}