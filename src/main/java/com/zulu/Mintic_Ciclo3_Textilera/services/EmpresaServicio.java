...
//________ Métodos: ____________________________________________________________________________________________________
    public List<Empresa> getEmpresas(){ return empresaRepositorio.findAll(); }

    public Empresa getEmpresa(Long id) {
        return empresaRepositorio.findById(id).get();
    }

    public void addEmpresas(Empresa listElement) { empresaRepositorio.save(listElement); }

    public void updateEmpresa(Empresa empresa) { empresaRepositorio.save(empresa); }
